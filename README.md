...
| [fluent-korean](skills/fluent-korean/) 🇰🇷 | A Claude Code output-style that stops the agent writing broken machine-Korean — dropped particles and endings, telegraphic noun strings, metaphor-swapped vocabulary. Install it when your agents report, hand off, or produce deliverables in Korean. | ⚪ `community` | 🔶 consent-gated (`files`) | MIT | [snflkd/fluent-korean](https://github.com/snflkd/fluent-korean/tree/v1.0.0/plugins/fluent-korean) `v1.0.0` |
| [hwpx-editing](skills/hwpx-editing/) 🇰🇷 | Teaches an agent to edit Hangul .hwpx files without corrupting them — verified HWPML editing rules plus Python tools for inspection, table generation, layout/typography audit, and conversion. | ⚪ `community` | 🔶 consent-gated (`files`) | MIT | [kangdacool/hwpx-editing-skill](https://github.com/kangdacool/hwpx-editing-skill/tree/d0f565c322ff45b3a5c7bf3e4aa21d3a15db9e99/skills/hwpx-editing) `d0f565c` |
...
| [jobstack](skills/jobstack/) 🇰🇷 | 16 skills covering a Korean job search end to end — company research, 이력서 and 자기소개서 drafting and review, NCS competency mapping for public-sector applications, portfolio review, salary analysis, and mock interviews. | ⚪ `community` | 🔶 consent-gated (`files`) | MIT | [thesun4sky/jobstack](https://github.com/thesun4sky/jobstack/tree/a5ef5ed8df2840e08bb7f2d2ab7fbab679bb3eff) `a5ef5ed` |
...
| [reviewer](agents/reviewer/) | A dedicated review agent — claims review tickets, runs the code-review skill on each diff, and reports blocking findings before merge. | 🟢 `official` | ⚡ one-click (`files`) | MIT | first-party — lives in this repo |
...
| Item | What it does | Tier | Install | License | Upstream pin |
| --- | --- | --- | --- | --- | --- |
| [ai-agents-for-beginners](knowledge/ai-agents-for-beginners/) | A structured beginner course on AI-agent concepts and implementations, with lessons on orchestration, tools, memory, planning, and multi-agent systems. | 🔵 `verified` | — reference | MIT | [microsoft/ai-agents-for-beginners](https://github.com/microsoft/ai-agents-for-beginners/tree/15ad10ca60577b75199c1ba828887ab7e66bac87) `15ad10c` |
| [awesome-ai-agent-papers](knowledge/awesome-ai-agent-papers/) | A community-maintained reading list of papers and resources on LLM agents, planning, tool use, memory, multi-agent systems, and evaluation. | ⚪ `community` | — reference | MIT | [VoltAgent/awesome-ai-agent-papers](https://github.com/VoltAgent/awesome-ai-agent-papers/tree/aa50c0c304c7bfb833e4b329a8c8d518f6771f42) `aa50c0c` |
...
| [awesome-mcp-servers](knowledge/awesome-mcp-servers/) | A broad, community-maintained directory of MCP servers for connecting agents to tools, data sources, and services. | ⚪ `community` | — reference | MIT | [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers/tree/375407c7290dd99d305938983f37adffa9d44275) `375407c` |
| [awesome-rag](knowledge/awesome-rag/) | A community index of retrieval-augmented generation papers, implementations, datasets, tutorials, and related techniques. | ⚪ `community` | — reference | Apache-2.0 | [awesome-rag/awesome-rag](https://github.com/awesome-rag/awesome-rag/tree/cca6aa9ad7f62288eafbb99de908ca7917f36347) `cca6aa9` |
| [bert](knowledge/bert/) | The original BERT implementation and pretrained-model release, a compact reference for bidirectional pretraining and language representation learning. | 🔵 `verified` | — reference | Apache-2.0 | [google-research/bert](https://github.com/google-research/bert/tree/eedf5716ce1268e56f0a50264a88cafad334ac61) `eedf571` |
| [claude-cookbooks](knowledge/claude-cookbooks/) | Official Anthropic examples for Claude application patterns, including tool use, retrieval, vision, extended thinking, and evaluation. | 🔵 `verified` | — reference | MIT | [anthropics/claude-cookbooks](https://github.com/anthropics/claude-cookbooks/tree/85016cacf5b7923aa62aa2b514399325e9d159e9) `85016ca` |
| [cs336-assignment1-basics](knowledge/cs336-assignment1-basics/) | The Stanford CS336 basics assignment, implementing core language-model components such as tokenization, attention, and training primitives. | 🔵 `verified` | — reference | MIT | [stanford-cs336/assignment1-basics](https://github.com/stanford-cs336/assignment1-basics/tree/a158843b20107949f1a8d7df1b05cd33b9166712) `a158843` |
| [cs336-assignment2-systems](knowledge/cs336-assignment2-systems/) | The Stanford CS336 systems assignment, focused on the systems work needed to train and serve language models efficiently. | 🔵 `verified` | — reference | MIT | [stanford-cs336/assignment2-systems](https://github.com/stanford-cs336/assignment2-systems/tree/ca8bc81a59b70516f7ebb2da4808daade877c736) `ca8bc81` |
...
| [haystack](knowledge/haystack/) | An open-source framework for production-ready LLM pipelines, retrieval-augmented generation, document search, and agentic applications. | 🔵 `verified` | — reference | Apache-2.0 | [deepset-ai/haystack](https://github.com/deepset-ai/haystack/tree/5add74ecda75c78271b26feeef7d897bfb4e7796) `5add74e` |
| [langchain](knowledge/langchain/) | A framework and reference implementation for composing LLM applications with models, prompts, retrievers, tools, agents, and structured workflows. | 🔵 `verified` | — reference | MIT | [langchain-ai/langchain](https://github.com/langchain-ai/langchain/tree/725489f135458c37c668919b0d08652ebd04f131) `725489f` |
| [llamaindex](knowledge/llamaindex/) | A framework and reference implementation for context augmentation, document ingestion, indexing, retrieval, and agent workflows over private data. | 🔵 `verified` | — reference | MIT | [run-llama/llama_index](https://github.com/run-llama/llama_index/tree/c864fcfa2c1d1f987ccdbcdab7b18e395c01ba86) `c864fcf` |
| [llm-course-huggingface](knowledge/llm-course-huggingface/) | A practical course covering transformer models, datasets, tokenizers, fine-tuning, demos, and advanced LLM topics with runnable notebooks. | 🔵 `verified` | — reference | Apache-2.0 | [huggingface/llm-course](https://github.com/huggingface/llm-course/tree/aaee936e5bbc959b5ab06f9b35406729efe74d1e) `aaee936` |
| [llm-course-mlabonne](knowledge/llm-course-mlabonne/) | A broad self-study curriculum spanning transformer foundations, fine-tuning, quantization, RAG, agents, and practical LLM engineering. | ⚪ `community` | — reference | Apache-2.0 | [mlabonne/llm-course](https://github.com/mlabonne/llm-course/tree/7abd96e8284bfae232048fdb77b52397a2114847) `7abd96e` |
| [lm-evaluation-harness](knowledge/lm-evaluation-harness/) | A unified framework for running reproducible language-model evaluations across many tasks, models, and benchmark configurations. | 🔵 `verified` | — reference | MIT | [EleutherAI/lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness/tree/f4d4b3de3ee6741a7151a9fe74945ee515262f4c) `f4d4b3d` |
| [micrograd](knowledge/micrograd/) | A tiny scalar-valued autograd engine and neural-network library that makes reverse-mode automatic differentiation understandable from first principles. | 🔵 `verified` | — reference | MIT | [karpathy/micrograd](https://github.com/karpathy/micrograd/tree/c911406e5ace8742e5841a7e0df113ecb5d54685) `c911406` |
| [model-context-protocol-docs](knowledge/model-context-protocol-docs/) | The official documentation for MCP, covering the protocol concepts, architecture, tools, resources, prompts, and implementation guidance. | 🔵 `verified` | — reference | MIT | [modelcontextprotocol/docs](https://github.com/modelcontextprotocol/docs/tree/573dc60c2e7aab2605b29d0bf27194aa7b02e4fb) `573dc60` |
| [nanogpt](knowledge/nanogpt/) | A compact repository for training and fine-tuning medium-sized GPT models, useful for studying the core language-model training loop. | 🔵 `verified` | — reference | MIT | [karpathy/nanoGPT](https://github.com/karpathy/nanoGPT/tree/3adf61e154c3fe3fca428ad6bc3818b27a3b8291) `3adf61e` |
| [neural-networks-zero-to-hero](knowledge/neural-networks-zero-to-hero/) | A code-first lecture series that builds neural networks, language models, and a GPT-style model from scratch. | 🔵 `verified` | — reference | MIT | [karpathy/nn-zero-to-hero](https://github.com/karpathy/nn-zero-to-hero/tree/73c3fcc741f0ec104ca850b1fb0df90e7e8d4cde) `73c3fcc` |
| [openai-cookbook](knowledge/openai-cookbook/) | Practical examples for building LLM applications, including prompting, structured outputs, embeddings, retrieval, agents, and evaluation. | 🔵 `verified` | — reference | MIT | [openai/openai-cookbook](https://github.com/openai/openai-cookbook/tree/0a796c4b95457a82dc090d0e31392deaf3b07f28) `0a796c4` |
| [peft](knowledge/peft/) | Hugging Face methods and examples for adapting large models with low-rank and other parameter-efficient fine-tuning techniques. | 🔵 `verified` | — reference | Apache-2.0 | [huggingface/peft](https://github.com/huggingface/peft/tree/9f1fe21d8131a24634d6d23c13efa2aae72b6cca) `9f1fe21` |
| [prompt-engineering-guide](knowledge/prompt-engineering-guide/) | A large reference guide to prompt-engineering techniques, reasoning patterns, model-specific practices, and related papers and resources. | ⚪ `community` | — reference | MIT | [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide/tree/57673726396dd94acb23bdb1e67f27c78ee85a8e) `5767372` |
| [transformers](knowledge/transformers/) | The central model and training library for modern transformer architectures, pretrained models, tokenizers, inference, and fine-tuning workflows. | 🔵 `verified` | — reference | Apache-2.0 | [huggingface/transformers](https://github.com/huggingface/transformers/tree/71c6f699ac9b3f8fc42a6a3e9dc59034c349a678) `71c6f69` |
| [trl](knowledge/trl/) | Hugging Face tooling and examples for post-training language models with supervised fine-tuning, preference optimization, and reinforcement-learning methods. | 🔵 `verified` | — reference | Apache-2.0 | [huggingface/trl](https://github.com/huggingface/trl/tree/922dc584664d87482935e1fa7d958930fc5223cf) `922dc58` |
